...
var GamePage = class _GamePage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GamePage, selectors: [["game-page"]], viewQuery: function GamePage_Query(rf, ctx) {
    if (rf & 1) {
  ...
  }, decls: 11, vars: 0, consts: [["mainCanvas", ""], [1, "w-full", "h-screen", "overflow-hidden", "flex", "flex-col"], ["title", "Gra Ciosy"], ["text", "Generator Map", "routerLink", "/generator"], ["text", "Wiki", "routerLink", "/wiki"], ["text", "Wyloguj", 3, "buttonClick"], [1, "size-full", "relative", "overflow-hidden", "select-none"], [1, "absolute", "inset-0", "z-0", "cursor-crosshair", "active:cursor-grabbing", 3, "mousedown", "mousemove", "mouseup", "mouseleave", "wheel"], [1, "absolute", "top-4", "left-4", "z-10"], [1, "absolute", "top-4", "right-4", "z-20", 3, "positionChange"], [1, "absolute", "bottom-4", "left-4", "z-10", "rounded-2xl", "w-60", "overflow-hidden", "bg-slate-900", 3, "regenerate"]], template: function GamePage_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(5, "div", 6)(6, "canvas", 7, 0);
      \u0275\u0275listener("mousedown", function GamePage_Template_canvas_mousedown_6_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.mouseService.onMouseDown($event));
      })("mousemove", function GamePage_Template_canvas_mousemove_6_listener($event) {
        \u0275\u0275restoreView(_r1);
        const mainCanvas_r2 = \u0275\u0275reference(7);
        return \u0275\u0275resetView(ctx.mouseService.onMouseMove($event, mainCanvas_r2));
      })("mouseup", function GamePage_Template_canvas_mouseup_6_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.mouseService.onMouseUp());
      })("mouseleave", function GamePage_Template_canvas_mouseleave_6_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.mouseService.onMouseUp());
      })("wheel", function GamePage_Template_canvas_wheel_6_listener($event) {
        \u0275\u0275restoreView(_r1);
        const mainCanvas_r2 = \u0275\u0275reference(7);
        return \u0275\u0275resetView(ctx.mouseService.onWheel($event, mainCanvas_r2));
      });
      \u0275\u0275elementEnd();
      \u0275\u0275element(8, "weather", 8);
      \u0275\u0275elementStart(9, "minimap", 9);
      \u0275\u0275listener("positionChange", function GamePage_Template_minimap_positionChange_9_listener() {
        \u0275\u0275restoreView(_r1);
        const mainCanvas_r2 = \u0275\u0275reference(7);
        return \u0275\u0275resetView(ctx.gameService.drawViewport(mainCanvas_r2));
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "info", 10);
      \u0275\u0275listener("regenerate", function GamePage_Template_info_regenerate_10_listener($event) {
        \u0275\u0275restoreView(_r1);
        const mainCanvas_r2 = \u0275\u0275reference(7);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(GamePage, { className: "GamePage", filePath: "src/app/game/game.ts", lineNumber: 22 });
})();
export {
  GamePage
};
//# sourceMappingURL=chunk-HZVBXV2N.js.map
