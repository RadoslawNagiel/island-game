...
var ButtonComponent = class _ButtonComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ButtonComponent, selectors: [["app-button"]], inputs: { text: [1, "text"], disabled: [1, "disabled"] }, outputs: { buttonClick: "buttonClick" }, decls: 2, vars: 5, consts: [[1, "px-8", "py-3", "bg-emerald-600", "hover:bg-emerald-500", "text-white", "rounded-xl", "font-bold", "shadow-lg", "shadow-emerald-900/50", "transition-all", "hover:-translate-y-1", "cursor-pointer", "w-full", 3, "click"]], template: function ButtonComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275classProp("pointer-events", ctx.disabled())("opacity-30", ctx.disabled());
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ButtonComponent, [{
    type: Component,
    args: [{ selector: "app-button", standalone: true, template: '<button\r\n  (click)="buttonClick.emit()"\r\n  class="px-8 py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold shadow-lg shadow-emerald-900/50 transition-all hover:-translate-y-1 cursor-pointer w-full"\r\n  [class.pointer-events.none]="disabled()"\r\n  [class.opacity-30]="disabled()"\r\n>\r\n  {{ text() }}\r\n</button>\r\n' }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HeaderComponent, [{
    type: Component,
    args: [{ selector: "app-header", standalone: true, template: '<header class="z-50 flex flex-col md:flex-row justify-between items-center border-b border-zinc-800 gap-4 p-6 pb-4 sticky top-0 bg-zinc-950">\r\n  <div>\r\n    <h1 class="text-4xl font-extrabold text-emerald-500 tracking-tight">{{ title() }}</h1>\r\n    <p class="text-zinc-500 mt-2">{{ subtitle() }}</p>\r\n  </div>\r\n\r\n  <div class="flex gap-4">\r\n    <ng-content></ng-content>\r\n  </div>\r\n</header>\r\n' }]
...
//# sourceMappingURL=chunk-R3G72D33.js.map
